...
export interface PythonExecOptions {
    ...
    /**
     * The working directory for the process. If not provided, the current workspace or python project
     * will be used. Current workspace or project root is determined based on the URI of the script being executed.
     */
    cwd?: string;

    /**
     * Environment variables to set when executing the python executable.
     */
 ...
 */
export interface PythonExecInfo {
    /**
     * Details on how to run the python executable.
     */
    run: PythonExecOptions;

    /**
     * Details on how to run the python executable after activating the environment.
     * If set this will override the `run` property.
     */
    activatedRun?: PythonExecOptions;

    /**
     * Details on how to create an activated environment.
     */
    activation?: PythonExecOptions[];

    /**
     * Details on how to deactivate the environment.
     */
    deactivation?: PythonExecOptions[];
}
...
export interface PythonEnvironmentInfo {
     ...
     */
    readonly execInfo?: PythonExecInfo;
...
export interface PackageInfo {
    ...
    /**
     * The condition under which the package is applicable.
     */
...
/**
 * Interface representing an upgradeable package.
 */
export interface UpgradeablePackage extends PackageInfo {
    /**
     * Indicates whether the package can be upgraded.
     */
...
export interface PackageManager {
     ...
     * @param packages - The packages to install, which can be an array of upgradeable packages or strings.
     * @returns A promise that resolves when the installation is complete.
     */
    install(environment: PythonEnvironment, packages: UpgradeablePackage[] | string[]): Promise<void>;
     ...
     */
    getPackages(environment: PythonEnvironment): Package[] | undefined;
...
export interface PythonPackageManagerApi {
     ...
     */
    installPackages(environment: PythonEnvironment, packages: UpgradeablePackage[] | string[]): Promise<void>;
